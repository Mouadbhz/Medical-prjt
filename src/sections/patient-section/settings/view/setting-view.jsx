...
export default function SettingsView() {
  ...
  const AccountAdress = account.adress;
  const AccountCountry = account.country;
  const AccountStateRegion = account.StateRegion;
  const AccountCity = account.city;
  const AccountZipCode = account.ZipCode;
  const AccountAbout = account.about;
